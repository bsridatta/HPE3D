...
def get_camera_data(camera=1, subject=1, param='r'):
    ...
    if param == 'r':
        val = cam_params['extrinsics'][f'S{subject}'][f'C{camera}']['R']
    elif param == 't':
        val = cam_params['extrinsics'][f'S{subject}'][f'C{camera}']['t']
    elif param == 'f':
        matrix = cam_params['intrinsics'][f'C{camera}']['calibration_matrix']
        val = [matrix[0][0], matrix[1][1]]
    elif param == 'c':
        matrix = cam_params['intrinsics'][f'C{camera}']['calibration_matrix']
        val = [matrix[0][2], matrix[1][2]]
    elif param == 'k':
        distortion = cam_params['intrinsics'][f'C{camera}']['distortion']
