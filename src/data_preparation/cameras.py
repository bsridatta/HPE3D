"""from https://github.com/una-dinosauria/3d-pose-baseline/blob/1ca400232ad6158050d8b292ac812d94dbb49d74/src/cameras.py"""
...
def load_cameras( bpath=f'{os.getenv("HOME")}/lab/HPE3D/src/data/cameras.h5', subjects=[1,5,6,7,8,9,11] ):
